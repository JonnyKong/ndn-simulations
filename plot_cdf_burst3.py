...
if __name__ == "__main__":
    ...
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3/1/raw/loss_rate_0.5.txt')
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3/2/raw/loss_rate_0.5.txt')
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3/3/raw/loss_rate_0.5.txt')

    plotter.plot_cdf(save=True, label_name='min distance=0')

    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist10/1/raw/loss_rate_0.5.txt')
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist10/2/raw/loss_rate_0.5.txt')
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist10/3/raw/loss_rate_0.5.txt')

    plotter.plot_cdf(save=True, label_name='min distance=10')

    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist30/1/raw/loss_rate_0.5.txt')
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist30/2/raw/loss_rate_0.5.txt')
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist30/3/raw/loss_rate_0.5.txt')

    plotter.plot_cdf(save=True, label_name='min distance=30')

    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist50/1/raw/loss_rate_0.5.txt')
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist50/2/raw/loss_rate_0.5.txt')
    plotter.add_file('/Users/petli2/projects/ndnSIM/ndn-simulations/burst_results/retrans30_burst3_dist50/3/raw/loss_rate_0.5.txt')

    plotter.plot_cdf(save=True, label_name='min distance=50')
